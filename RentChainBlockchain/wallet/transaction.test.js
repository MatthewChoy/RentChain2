...
const Wallet = require('RentChainBlockchain/wallet/index');
const { verifySignature } = require('RentChainBlockchain/utility');
const { REWARD_INPUT, MINING_REWARD } = require('RentChainBlockchain/config');
